...
try {
  await page1.goto('https://8081-aabdbffdadabafcfdbcfacbdcbaeadbebabcdebdca.premiumproject.examly.io/viewTutors');
  ...
  await page1.waitForSelector('table tbody tr', { timeout: 5000 });
      ...
      if (rowCount > 0) 
      {
        console.log('TESTCASE:Tutors_table_rows_exist:success');
      } 
      else 
      {
        console.log('TESTCASE:Tutors_table_rows_exist:failure');
      }
    } 
    catch (e) 
    {
...
try {
  await page2.goto('https://8081-aabdbffdadabafcfdbcfacbdcbaeadbebabcdebdca.premiumproject.examly.io/addNewTutor');
  ...
  if (formExists) {
    console.log('TESTCASE:CreateTutor_form_exists_and_input_fields_present_in_Create_Tutor:success');
  } else {
    console.log('TESTCASE:CreateTutor_form_exists_and_input_fields_present_in_Create_Tutor:failure');
  }
...
try {
  await page3.goto('https://8081-aabdbffdadabafcfdbcfacbdcbaeadbebabcdebdca.premiumproject.examly.io/viewTutors');
  ...
  if (headerMatch) {
    console.log('TESTCASE:Tutor_table_header_content:success');
  } else {
    console.log('TESTCASE:Tutor_table_header_content:failure');
  }
} catch (e) {
  console.log('TESTCASE:Tutor_table_header_content:failure');
}
...
try {
  await page4.goto('https://8081-aabdbffdadabafcfdbcfacbdcbaeadbebabcdebdca.premiumproject.examly.io/viewTutors');
...
try {
  await page5.goto('https://8081-aabdbffdadabafcfdbcfacbdcbaeadbebabcdebdca.premiumproject.examly.io/addNewTutor');
  ...
  if (isValidationFailed) {
    console.log('TESTCASE:Verify_required_validation_on_Add_Tutor_button:failure');
  } else {
    console.log('TESTCASE:Verify_required_validation_on_Add_Tutor_button:success');
  }
} catch (error) {
  console.log('TESTCASE:Verify_required_validation_on_Add_Tutor_button:failure');
}
