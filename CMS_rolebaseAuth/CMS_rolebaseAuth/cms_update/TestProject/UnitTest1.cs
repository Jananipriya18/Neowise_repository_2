...
//     string requestBodyAdmin = $"{{\"Username\": \"{uniqueUsername}\", \"Password\": \"abc@123A\", \"Email\": \"{uniqueEmail}\", \"MobileNumber\": \"1234567890\", \"UserRole\": \"Admin\"}}";
...
//     string loginRequestBodyAdmin = $"{{\"Email\" : \"{uniqueEmail}\",\"Password\" : \"abc@123A\"}}";
...
//     {
//         // Use the obtained ContainerId in the newAssignment JSON
//         long containerId = (long)createdContainer.containerId;
...
//         // Extract the created assignment from the response
//         var createdAssignment = JsonConvert.DeserializeObject<dynamic>(await postAssignmentResponse.Content.ReadAsStringAsync());
